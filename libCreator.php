<?php
    ...
    */
    ...
    moveDirectory($source, $destination);
    createLibPhp();
    createFileInDirectory("api/v1", "lib.php");
    writeToFile($texto, "api/v1/lib.php");

    echo "<br><br><a href='authCreator.php'>Go to auth creator</a>";

    function createLibPhp() {
        global $texto;
        $texto = "
<?php
/*!
...
* \param \$url (string) Url to request.
* \return \$result (string) Returns the content of the get request if the curl execution was successful, false if not.
*/
