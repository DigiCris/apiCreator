<?php
    ...
    */
    ...
    createFileInDirectory("api/v1", "configuracion.php");
    CrearConfiguracion($DBNAME,$DBUSER, $DBPASSWD);
    writeToFile($texto, "api/v1/configuracion.php");

    echo "<br><br><a href='tableCreator.php'>Go to table creator</a>";



    function  CrearConfiguracion($DBNAME,$DBUSER, $DBPASSWD) {
        global $texto;
